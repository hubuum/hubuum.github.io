...
| [02 Orbit](orbit.html) | A luminous hub within a constellation. Midnight blue, mint, a centred opening. | [Desktop](previews/orbit-desktop.jpg) | [Mobile](previews/orbit-mobile.jpg) |
...
The system font stack and base teal follow the existing shared documentation
theme in `hubuum/.github`, pinned at
`c026918decd83c681fedf0c4c61c266284ae4020`. These standalone studies do not load
the documentation layout CSS. Once a direction is chosen, shared brand rules
can live in that theme, with landing-specific layout in this repository.
